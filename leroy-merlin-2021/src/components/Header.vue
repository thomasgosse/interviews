<template>
  <header>
    <div class="title">
      <svg viewBox="0 0 482.2 289.8" id="logo-lm">
        <path
          class="logo-triangle"
          fill="#78BE20"
          d="M428.8 289.8c-125.8 0-251.7 0-377.5 0 -0.3-0.3-0.5-0.6-0.8-0.9 0.8-0.4 1.7-0.6 2.3-1.2 26.2-25.9 52.3-51.8 78.4-77.6 30.6-30.3 61.1-60.5 91.7-90.8 5.3-5.3 10.7-10.4 16-15.8 1.7-1.7 2.6-1.7 4.3 0 29.8 30 59.8 59.9 89.7 89.8 31.5 31.5 62.9 63 94.4 94.4 0.6 0.6 1.3 1.1 2 1.6C429.1 289.5 429 289.7 428.8 289.8z"
        ></path>
        <path
          class="logo-letters"
